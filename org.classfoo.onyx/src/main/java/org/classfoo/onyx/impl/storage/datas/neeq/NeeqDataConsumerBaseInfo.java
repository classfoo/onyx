 ...
 *
 */
public class NeeqDataConsumerBaseInfo implements OnyxStreamingMessageListener {
    ...
    public NeeqDataConsumerBaseInfo(OnyxService onyxService, String kid) {
    ...
    private void addLegalRepresentative(String legalRepresentative, String companyName, String code,
        ...
        if (legalRepresentativeEntity == null) {
            HashMap<String, Object> legalRepresentativeEntityProperties = new HashMap<String, Object>(32);
    ...
    private void addSecretaries(String secretaries, String companyName, String code, Map<String, Object> company,
        ...
        if (secretariesEntity == null) {
            HashMap<String, Object> secretariesEntityProperties = new HashMap<String, Object>(32);
