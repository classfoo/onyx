...
/**
 * Neeq Data Consumer of Company Info Datas
 * @author ClassFoo
 * @createdate 20180102
 */
public class NeeqDataConsumerCompanyInfo implements OnyxStreamingMessageListener {

    private OnyxService onyxService;

    private OnyxStorageSession session;

    public NeeqDataConsumerCompanyInfo(OnyxService onyxService, String kid) {
