...
public class NeeqData {
    ...
    public void initTestData(OnyxStorageSession session) {
        ...
        consumer.registListener("executives.csv", new NeeqDataConsumerExecutives(this.onyxService, kid));
        consumer.registListener("baseinfo.csv", new NeeqDataConsumerBaseInfo(this.onyxService, kid));
        consumer.registListener("topTenHolders.csv", new NeeqDataConsumerTopTenHolders(this.onyxService, kid));
        consumer.registListener("tradeInfo.csv", new NeeqDataConsumerTradeInfo(this.onyxService, kid));
        consumer.start();
